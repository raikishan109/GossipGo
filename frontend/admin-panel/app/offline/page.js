  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-surface px-4 py-12">
      <div className="w-full max-w-lg rounded-[2rem] border border-[rgb(var(--border))] bg-card/90 p-8 text-center shadow-glow sm:p-10">
        ...
        <h1 className="mt-4 font-display text-4xl text-text sm:text-5xl">Admin panel offline</h1>
        <p className="mt-4 text-sm text-muted sm:text-base">
          The admin shell is installed, but moderation data needs a connection before it can refresh.
        </p>
